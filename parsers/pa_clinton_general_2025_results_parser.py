#!/usr/bin/env python3
"""
Parser for Clinton County, PA 2025 General Election precinct results.

Source: Clinton County Precinct.pdf (Electionware format).

Usage:
    python parsers/pa_clinton_general_2025_results_parser.py \\
...
# office headers; add/remove as needed for Clinton.
EXACT_OFFICES = {
...
CONFIG = ElectionwareConfig(
    ...
    county_header_suffix="Clinton County",
