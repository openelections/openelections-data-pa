...
CONTEST_TO_OPENELECTIONS_OFFICE_PARTY_AND_DISTRICT = {
    ...
    'DEM SENATOR IN THE GENERAL ASSEMBLY 39th DISTRICT': ('State Senator', 'DEM', 39),
    'REP SENATOR IN THE GENERAL ASSEMBLY 39th DISTRICT': ('State Senator', 'REP', 39),
    'DEM SENATOR IN THE GENERAL ASSEMBLY 41st DISTRICT': ('State Senator', 'DEM', 41),
    'REP SENATOR IN THE GENERAL ASSEMBLY 41st DISTRICT': ('State Senator', 'REP', 41),
    'DEM SENATOR IN THE GENERAL ASSEMBLY 45th DISTRICT': ('State Senator', 'DEM', 45),
    'REP SENATOR IN THE GENERAL ASSEMBLY 45th DISTRICT': ('State Senator', 'REP', 45),
