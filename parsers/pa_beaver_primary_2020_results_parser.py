...
OUTPUT_FILE = os.path.join('..', '2020', '20200602__pa__primary__beaver__precinct.csv')
OUTPUT_HEADER = ['county', 'precinct', 'office', 'district', 'party', 'candidate', 'votes']

BEAVER_FILE = os.path.join('..', '..', 'openelections-sources-pa', '2020',
                           'Beaver PA 2020 Primary PrecinctResults.pdf')

BEAVER_HEADER = [
    'Summary Results Report',
    '2020 General Primary Election',
    'June 2, 2020',
    'OFFICIAL RESULTS',
    'Beaver County',
]
