...
OUTPUT_FILE = os.path.join('20201103__pa__general__lebanon__precinct.csv')
OUTPUT_HEADER = ['county', 'precinct', 'office', 'district', 'party', 'candidate', 'votes']

LEBANON_FILE = '/Users/derekwillis/code/openelections-sources-pa/2020/general/Lebanon PA 2020 General Election Precinct Results.pdf'
LEBANON_HEADER = [
    '',
...
FIRST_FOOTER_SUBSTRING = 'Precinct Summary - 11/19/2020'
...
RAW_OFFICE_TO_OFFICE_AND_DISTRICT = {
    ...
    'REP IN CONGRESS 9TH DISTRICT': ('U.S. House', 9),
    'REP GENERAL ASSEMBLY 101st': ('General Assembly', 101),
    'REP GENERAL ASSEMBLY 102nd': ('General Assembly', 102),
    'REP GENERAL ASSEMBLY 104th': ('General Assembly', 104),
}
