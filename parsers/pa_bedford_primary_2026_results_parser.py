#!/usr/bin/env python3
"""Parse Bedford County PA 2026 Primary precinct results.

Source: Bedford County Certified SOVC Report 2026 Primary 06.08.2026.pdf
...
Adapted from pa_bedford_primary_2024_results_parser.py with an updated
HEADER_RE / OFFICE_MAP for the 2026 contest names.

Usage:
    python parsers/pa_bedford_primary_2026_results_parser.py <input.pdf> <output.csv>
"""
    ...
    for i in range(start_page, last):
        ...
        for tbl in tables:
            ...
            for row in tbl[1:]:
                ...
                if upper_label in ("BEDFORD COUNTY", "PAGE") or upper_label.startswith("PAGE"):
                    continue
                if label in VOTE_METHODS:
                    continue
                if "BEDFORD COUNTY - TOTAL" in upper_label or "COUNTY - TOTAL" in upper_label:
                    continue
